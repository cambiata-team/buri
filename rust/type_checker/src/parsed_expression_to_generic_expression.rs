...
fn translate_binary_operator_add_arithmetic_constraints(
    ...
    match schema
        .add_constraint(id_collection.type_id, constrain_equal_to_num())
...
fn translate_binary_operator_add_concatenate_constraints(
    ...
    match schema
        .add_constraint(id_collection.type_id, constrain_equal_to_str())
        .and_then(|_| schema.add_constraint(id_collection.left_child_id, constrain_equal_to_str()))
